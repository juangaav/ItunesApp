 ...
 */
public class SelectedCategoryAppsListAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<App> selectedCategoryApps;

    public SelectedCategoryAppsListAdapter(Context context, ArrayList<App> selectedCategoryApps) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.apps_list_listview_item, null);
